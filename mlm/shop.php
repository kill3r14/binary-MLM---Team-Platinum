        ...
        <!-- Begin Page Content -->
         ...
         <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="jumbotron page-header">Products</h1>
                    </div>
                    <br><br><br><br>
                    <!-- /.col-lg-12 -->
                </div>
...
<p>Redirects to sellers site.</p>
    <div class="row">
        ...
        <div class="panel price panel-green">
            ...
            <div class="panel-body text-center">
                <p class="lead" style="font-size:30px"><strong>₹300/-</strong></p>
            </div>
            <ul class="list-group list-group-flush text-center">
                ...
                <li class="list-group-item"><i class="icon-ok text-success"></i> Valedity</li>
            </ul>
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
        ...
        <div class="panel price panel-green">
            ...
            <div class="panel-body text-center">
                <p class="lead" style="font-size:30px"><strong>₹600/- </strong></p>
            </div>
            <ul class="list-group list-group-flush text-center">
                    <li class="list-group-item"><i class="icon-ok text-success"></i> Product</li>
                    <li class="list-group-item"><i class="icon-ok text-success"></i> description</li>
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
        ...
        <div class="panel price panel-green">
            ...
            <div class="panel-body text-center">
                <p class="lead" style="font-size:30px"><strong>₹900/-</strong></p>
            </div>
            <ul class="list-group list-group-flush text-center">
                    <li class="list-group-item"><i class="icon-ok text-success"></i> Product</li>
                    <li class="list-group-item"><i class="icon-ok text-success"></i> description</li>
  ...
  color:#fff;
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
        ...
        <div class="panel price panel-grey">
            ...
            <div class="panel-body text-center">
                <p class="lead" style="font-size:30px"><strong>₹1200/-</strong></p>
            </div>
            <ul class="list-group list-group-flush text-center">
                    <li class="list-group-item"><i class="icon-ok text-success"></i> Product</li>
                    <li class="list-group-item"><i class="icon-ok text-success"></i> description</li>
